...
import { Button, DatePicker, TimePicker, message } from "antd"; // Import DatePicker and TimePicker from antd
...
function ProductInfo({ params }: { params: { product_id: string } }) {
  ...
  const [selectedDate, setSelectedDate] = useState<any>(null); // State for selected date
  const [selectedTime, setSelectedTime] = useState<any>(null); // State for selected time
            ...
            <div className="flex gap-5">
              <Button
                ...
                onClick={() => {
                  ...
                  message.success("Item Added To Booking");
                }}
