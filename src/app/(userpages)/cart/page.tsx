...
import { RiCarLine, RiShoppingCartLine, RiSubtractLine, RiAddLine } from "react-icons/ri";
...
function Cart() {
  ...
  return (
    <div>
      {items.length > 0 && (
        <div>
          <h1 className="text-2xl font-bold text-gray-800 my-5">My Booking</h1>
        </div>
      )}
          ...
          <div className="grid grid-cols-3 gap-10">
            <div className="col-span-2">
              <div className="grid grid-cols-5 gap-2 my-5">
                ...
                <h1 className="text-sm">Price per hour</h1>
